...
x=np.load('/../data/legal_NLP/legalNLP_data/final_embd_files/sent2vec_embd_files/final_sv_mincount5_dim200_Vsize750000_Ngram2/train_embd_final_sv_mincount5_dim200_Vsize750000_Ngram2.npy',allow_pickle='true')
x_train_data=x[:,0]
y_train=x[:,1]
...
y=np.load('/../data/legal_NLP/legalNLP_data/final_embd_files/sent2vec_embd_files/final_sv_mincount5_dim200_Vsize750000_Ngram2/test_embd_final_sv_mincount5_dim200_Vsize750000_Ngram2.npy',allow_pickle='true')
x_test_data=y[:,0]
y_test=y[:,1]
...
z=np.load('/../data/legal_NLP/legalNLP_data/final_embd_files/sent2vec_embd_files/final_sv_mincount5_dim200_Vsize750000_Ngram2/validation_embd_final_sv_mincount5_dim200_Vsize750000_Ngram2.npy',allow_pickle='true')
x_dev_data=z[:,0]
y_dev=z[:,1]
