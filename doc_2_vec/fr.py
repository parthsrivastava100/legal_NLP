...
x_train=np.load('train_embd_1000.npy')
y_train=np.load('train_val.npy')
x_test=np.load('test_embd_1000.npy')
y_test=np.load('test_val.npy')
x_dev=np.load('validation_embd_1000.npy')
...
LR_scores(x_train,x_dev,x_test,y_train,y_dev,y_test)